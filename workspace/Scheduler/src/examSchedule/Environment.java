...
import examSchedule.parser.OrBasedSolution;
...
public class Environment extends PredicateReader implements
	...
	public static Vector<Lecture> lectures = new Vector<Lecture>();
	public static OrBasedSolution currSolution;
	...
	public void setCurrentSolution(SolutionInterface currentSolution) {
		currSolution = (OrBasedSolution) currentSolution;
		currSolution.env = this;
	}
